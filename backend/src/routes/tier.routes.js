...
// Controllers
import tierManagementController from "../controllers/tier.management.controller.js";
import hostSubscriptionController from "../controllers/host.subscription.controller.js";
...
adminRouter.use(authorize({minRole:"ADMIN"}));
