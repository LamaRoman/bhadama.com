...
import * as discoveryService from "../services/listing.discovery.service.js";
 ...
 */
router.put("/admin/feature/:listingId", authenticate, authorize({minRole:"ADMIN"}), async (req, res) => {
  try {
    const listingId = parseInt(req.params.listingId);
