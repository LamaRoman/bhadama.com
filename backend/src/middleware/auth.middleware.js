...
/**
 * Require specific primary roles (USER, HOST, ADMIN)
...
export const authorize = (...allowedRoles) => {
  return (req, res, next) => {
    ...
    // Super admin bypasses all primary role checks
 ...
 * @example requireAdminLevel(ADMIN_HIERARCHY.MODERATOR)
 */
 ...
 * @example requireAdminRole('FINANCE') - only FINANCE + SUPER_ADMIN
 * @example requireAdminRole('FINANCE', 'ANALYST') - only FINANCE, ANALYST + SUPER_ADMIN
 */
 ...
 * @example requirePermission('refunds.process')
 */
 ...
 * @example requireStrictOperation('refund.process')
 */
...
/**
 * Generic role middleware (legacy compatibility)
 */
export const roleMiddleware = (allowedRoles) => {
  return authorize(...(Array.isArray(allowedRoles) ? allowedRoles : [allowedRoles]));
};
