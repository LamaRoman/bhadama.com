// prisma/seeds/notificationTemplateSeed.mjs
...
async function main() {
  ...
  for (const template of DEFAULT_TEMPLATES) {
    try {
      ...
      console.error(`  ❌ Failed: ${template.slug} (${template.channel}):`, error.message);
    }
  }

  console.log(`\n✨ Done! Created: ${created}, Updated: ${updated}, Total: ${DEFAULT_TEMPLATES.length}`);
}
