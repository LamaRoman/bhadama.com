...
import OperatingHoursInput from "../../../../components";
...
export default function NewListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validation
    if (!form.hourlyRate) {
      setError("Please set an hourly rate");
      setLoading(false);
      setUploadProgress("");
      return;
    }
    ...
    const hasOpenDay = Object.values(operatingHours).some(
      (day) => !day.closed
    );
    if (!hasOpenDay) {
      setError("At least one day must be open for bookings");
      setLoading(false);
      setUploadProgress("");
      return;
    }
    ...
    try {
      ...
      const listingData = {
        ...form,
        hourlyRate: Math.round(parseFloat(form.hourlyRate) * 100) / 100,
      ...
      <div className="max-w-4xl mx-auto px-5">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">
            Share your space for events, parties, and gatherings
          </p>
        </div>
        ...
        {uploadProgress && !success && (
          <div className="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg flex items-start gap-3 animate-slide-in">
            <svg
              className="w-5 h-5 flex-shrink-0 mt-0.5 animate-spin text-blue-600"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Set your hourly rate and booking constraints
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    placeholder="500"
                    className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-gray-900"
              ...
              <div>
                ...
                <input
                  ...
                  value={form.minHours}
                  onChange={(e) =>
                    setForm({ ...form, minHours: e.target.value })
                  }
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  value={form.maxHours}
                  onChange={(e) =>
                    setForm({ ...form, maxHours: e.target.value })
                  }
                  required
                />
              </div>
          ...
          {/* Operating Hours Card - NEW COMPONENT */}
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-2">
              Operating Hours
            </h2>
            <p className="text-sm text-gray-600 mb-4">
              Set when your yard is available for bookings. You can set different
              hours for each day, mark days as closed, or enable 24-hour
              availability.
            </p>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Show guests what your yard looks like
            </p>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Consider enabling 24-hour availability for venues that support it</li>
              </ul>
            </div>
          </div>
        </div>
