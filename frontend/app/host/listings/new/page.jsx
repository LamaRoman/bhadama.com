...
import OperatingHoursInput from "../../../../components/OperatingHoursInput.jsx";
...
// Default operating hours structure with is24Hours support
...
export default function NewListing() {
  ...
  // Operating hours as separate state (per-day configuration)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare listing data with new operatingHours structure
      const listingData = {
        ...form,
        ...
        operatingHours: operatingHours, // Now includes is24Hours for each day
      };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Set when your yard is available for bookings. You can configure different hours for each day, 
              mark days as closed, or enable 24-hour availability.
            </p>
