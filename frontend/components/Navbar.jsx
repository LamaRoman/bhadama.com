...
const useAuth = () => ({
  user: { name: "John Doe", email: "john@example.com", role: "HOST" },
    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* Blog Link - Simple gray/white style */}
          <Link
            href="/blogs"
            className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors"
          >
          ...
          {!user ? (
            <>
              <Link
                href="/"
                className="hidden sm:block px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors"
              >
                Browse Spaces
              </Link>
              <Link
            ...
            <div className="relative flex items-center gap-3" ref={dropdownRef}>
              {/* List Space - Simple gray/white style */}
              {user.role === "HOST" && (
                <Link
                  href="/host/listings/new"
                  className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 bg-white hover:bg-gray-50 rounded-lg border border-gray-300 transition-colors"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                ...
                <div className="relative">
                  <div className="w-9 h-9 bg-gray-700 rounded-full flex items-center justify-center text-white font-semibold shadow-sm">
                  ...
                  <div className="p-4 bg-gray-50 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span className="inline-block mt-1 px-2 py-0.5 bg-white text-xs font-medium text-gray-700 rounded border border-gray-300">
