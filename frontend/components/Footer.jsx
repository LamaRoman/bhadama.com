    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-10">
          ...
          {/* Column: Blog */}
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-white mb-3">Blog</h3>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <a
                  href="/blogs?category=HOSTING_TIPS"
              ...
              <li>
                <a
                  href="/blogs?category=EVENT_EXPERIENCE"
                  className="hover:text-white"
                >
                  Event Stories
                </a>
              ...
              <li>
                <a
                  href="/blogs?category=INSPIRATION"
                  className="hover:text-white"
                >
                  Inspiration
                </a>
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/list-property" className="hover:text-white">
                  List Your Property
                </a>
              </li>
              <li>
